...
<<<<<<< HEAD
     ...
     * <ul>
     * <li>
     * <b>selected</b>: Sets if this is the default selection shown to a signer. Use true/false to show the value is selected or
     * not. Only one selection can be true.</li>
     * <li>
     * <b>text</b>: The text shown in the dropdown list.</li>
     * <li>
     * <b>value</b>: The value used when the selected.</li>
     * </ul>
     * 
     * @param listItems the list items
     */
    public void setListItems(final List<SelectOption> listItems) {
...
=======
	...
	/**
	 * Sets the list items. Only used with list tabs. These are the possible
	 * selections for a dropdown list. Each selection has three parts:
	 * <ul>
	 * <li>
	 * <b>selected</b>: Sets if this is the default selection shown to a signer.
	 * Use true/false to show the value is selected or not. Only one selection
	 * can be true.</li>
	 * <li>
	 * <b>text</b>: The text shown in the dropdown list.</li>
	 * <li>
	 ...
	 *            the list items
	 */
	public void setListItems(List<SelectOption> listItems) {
		this.listItems = listItems;
	}
