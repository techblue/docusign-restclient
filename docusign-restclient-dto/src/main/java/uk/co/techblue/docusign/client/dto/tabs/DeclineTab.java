...
/**
 * Place this tag on the document where you want to give the recipient the option of declining an envelope. If the recipient
 * clicks the Decline tag during the signing process, the envelope is voided.
 */
