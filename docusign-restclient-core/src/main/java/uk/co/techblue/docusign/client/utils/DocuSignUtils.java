...
public class DocuSignUtils {
    ...
    public static final String ENVELOPE_DEFINITION = "envelope_definition";
    ...
    public static MultipartFormDataOutput generateMultipartFormDataOutput(
        ...
        dataOut.addFormData(ENVELOPE_DEFINITION, signatureRequest, MediaType.APPLICATION_JSON_TYPE);
